...
import co.quindio.sena.tutorialwebservice.fragments.TemperaturaFragment;
import co.quindio.sena.tutorialwebservice.interfaces.IFragments;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,IFragments,TemperaturaFragment.OnFragmentInteractionListener,Presion_y_AltitudFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggle.syncState();
//FRAGMEN DE INICIO
        Fragment miFragment=new LogionFragment();
              //  BienvenidaFragment();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
           ...
           miFragment=new DesarrolladorFragment();
            ...
            miFragment=new TemperaturaFragment();
            fragmentSeleccionado=true;
        }else if (id == R.id.nav_humedad) {
            miFragment= new HumedadFragment();
            fragmentSeleccionado=true;
        }else if (id == R.id.nav_presion) {
            miFragment= new Presion_y_AltitudFragment();
            fragmentSeleccionado=true;
        }
